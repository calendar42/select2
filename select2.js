    ...
    */
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        updateResults: function (initial) {
            ...
            if (search.val().length < opts.minimumInputLength) {
                ...
                // small edit here to check for the existence of this.showSearch as the multi doesn't have that
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            this.container.on("mousedown touchstart", selector, this.bind(function (e) {
                if (!this.isInterfaceEnabled()) return;
        ...
        postprocessResults: function (data, initial, noHighlightUpdate) {
            ...
            if (this.highlight() == -1 && noHighlightUpdate !== false && this.opts.autoSelectFirst === true){
                self.highlight(0);
            }

            //If all results are chosen render formatNoMAtches
            if(!this.opts.createSearchChoice && choices.filter('.select2-result:not(.select2-selected)').length <= 0 && checkFormatter(this.opts.formatNoMatches, "formatNoMatches")){
